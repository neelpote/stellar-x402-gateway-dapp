...
5. In a terminal, run `npm run verify:challenge` to show an actual 402 response.
6. Run `npm run pay:agent` using a funded Stellar testnet account to show the real signed payment retry and 200 response.
